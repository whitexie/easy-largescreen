...
const canvasContainerRef = useTemplateRef('containerRef');
...
/** 框选 */
const { isBrushing, boxSelectionRect } = useBoxSelection(canvasContainerRef, { onSelect: handleBoxSelection });
    ...
    <main class="h-calc[100%-50px] w-full relative grid grid-cols-3 canvas-warpper bg-#f2f2f2">
      ...
      <div class="relative">
        <div
          ...
          @click.stop="designerStore.setCurrentWidget(null)"
        >
          <DesignerCanvas>
